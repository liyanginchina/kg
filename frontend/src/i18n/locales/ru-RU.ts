export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в KGBuddy',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в KGBuddy',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      bashDesc: 'Выполнить shell-команду в песочнице (deny-list, без сети, только временная папка сессии)',
      writeFile: 'Записать файл',
      writeFileDesc: 'Записать файл во временную папку сессии песочницы (нет доступа за её пределами)',
      ...
      groupShell: 'Shell / Файловые операции',
